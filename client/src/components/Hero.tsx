...
export function Hero() {
  ...
  return (
    <section className="relative isolate min-h-[710px] md:min-h-[710px] lg:min-h-[860px] overflow-hidden bg-[#f5f1e8] text-[#1f1d1a]" id="top">
      <HeroColorPanelsRoot
        className="absolute inset-0 z-0"
        showBadges={false}
        srTitle="Rishebs portfolio"
      >
        <HeroColorPanelsContainer className="container relative z-10 grid min-h-[710px] lg:min-h-[860px] items-center gap-10 pb-24 pt-32 sm:pb-28 lg:grid-cols-[minmax(340px,0.9fr)_minmax(360px,1.1fr)] lg:gap-14 lg:pt-28 xl:grid-cols-[0.8fr_1.2fr]">
